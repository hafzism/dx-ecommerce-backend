...
import { adminAddCategories, adminAddProducts, adminDeleteCategories, adminDeleteOrders, adminDeleteProducts, adminDisableUsers, adminEnableUsers, adminloginfn, adminUpdateCategories, adminUpdateOrders, adminUpdateProducts, adminViewCategories, adminViewOrders, adminViewProducts, adminViewSpecificCategories, adminViewUsers, loadhome } from '../controllers/adminControllers.js'
...
router.put('/products/:id',upload.single("image"),adminUpdateProducts)
...
router.get('/categories/:id',adminViewSpecificCategories)
